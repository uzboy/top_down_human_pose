...
backbone_cfg.resum_path=""      #./pth/mobilenet_v2_206.pth
backbone_cfg.in_channels=3
backbone_cfg.out_indices=-1
backbone_cfg.frozen_stages=None
backbone_cfg.pre_name="mobilenet_v2_with_loss_weight"
backbone_cfg.base_path = "./pth"

###############################################################################################
head_cfg = edict()
head_cfg.name = "TopdownHeatmapSimpleHead"
head_cfg.pre_name="mobilenet_v2_top_simple_head_with_loss_weight"
head_cfg.resum_path=""      #./pth/mobilenet_v2_top_simple_head_206.pth
...
#########################################################################
loss_cfg = edict()
loss_cfg.name = "JointsMSEWithWeightLoss"
...
lr_schedule_cfg.step = [70, 140, 200, 240]
