...
backbone_cfg.deep_stem=True
backbone_cfg.avg_down=True
backbone_cfg.groups=1
backbone_cfg.width_per_group=4
backbone_cfg.radix=2
backbone_cfg.reduction_factor=4
